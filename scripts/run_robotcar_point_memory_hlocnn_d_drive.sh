...
if [[ "$LANDMARK_MATCH_MODE" == image_obs* ]]; then
  DEFAULT_RESULT_NAME="${LANDMARK_MATCH_MODE}_${FEATURE}"
else
  DEFAULT_RESULT_NAME="${LANDMARK_MATCH_MODE}_${FEATURE}_obs${POINT_MEMORY_MAX_OBS}_${POINT_MEMORY_OBS_SELECT}"
fi
RESULT_NAME=${RESULT_NAME:-$DEFAULT_RESULT_NAME}
