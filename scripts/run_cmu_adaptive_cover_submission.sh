...
RESULT_NAME=${RESULT_NAME:-plmloc_${FEATURE}_top${CMU_TOPK}_${MEMORY_TAG}_${PNP_TAG}}
...
CMU_SUB="$SUB/CMU_eval_PLMLoc_${FEATURE}_top${CMU_TOPK}_${MEMORY_TAG}_${PNP_TAG}.txt"
