...
RESULT_NAME=${RESULT_NAME:-plmloc_${FEATURE}_${RETRIEVAL_TAG}_${POINT_MEMORY_OBS_TAG}_k${POINT_MEMORY_ADAPTIVE_K_MIN}_${POINT_MEMORY_ADAPTIVE_K_MAX}_gain${GAIN_TAG}_${PNP_TAG}${POSE_TAG}${MAXQ_TAG}}
...
AACHEN_SUB="$SUB/Aachen_v1_1_eval_PLMLoc_${FEATURE}_${RETRIEVAL_TAG}_${POINT_MEMORY_OBS_TAG}_k${POINT_MEMORY_ADAPTIVE_K_MIN}_${POINT_MEMORY_ADAPTIVE_K_MAX}_gain${GAIN_TAG}_${PNP_TAG}${POSE_TAG}${MAXQ_TAG}.txt"
