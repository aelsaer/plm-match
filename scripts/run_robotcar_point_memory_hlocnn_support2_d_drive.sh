...
# RobotCar Seasons v2 PLM run using the GreatCourt-style SuperPoint support-2 tweak.
...
RESULT_DIR=${RESULT_DIR:-$RUN_ROOT/results/mixvpr10/point_memory_hloc_nn_obs16_diverse_topk7_support2}
