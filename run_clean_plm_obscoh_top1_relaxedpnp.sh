...
OUT=outputs/loo_aachen_benchmark/loo_aachen_500/plm_clean_spobs_obscoh_top1_relaxedpnp
...
TORCH_HOME=/tmp/torch-hub /home/andreas/anaconda3/envs/sam3/bin/python \
  ...
  --override matching.local_memory.observation_coherence.min_unique_anchors=12 \
  --override matching.local_memory.observation_coherence.min_unique_landmarks=12 \
  --override matching.local_memory.observation_coherence.score_weight=1.0 \
  --override matching.local_memory.observation_coherence.anchor_weight=0.05 \
  --override matching.local_memory.observation_coherence.landmark_weight=0.02 \
  --override matching.local_memory.observation_coherence.staticness_weight=0.02 \
