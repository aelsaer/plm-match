...
OUT=outputs/loo_aachen_benchmark/loo_aachen_500/plm_clean_spobs_obscoh_top1_graphsupport
...
TORCH_HOME=/tmp/torch-hub /home/andreas/anaconda3/envs/sam3/bin/python \
  ...
  --override matching.local_memory.landmarks_per_anchor=3 \
  ...
  --override matching.local_memory.observation_coherence.enabled=true \
  --override matching.local_memory.observation_coherence.candidates_per_anchor=3 \
  --override matching.local_memory.observation_coherence.group_by=observer_covisibility \
  --override matching.local_memory.observation_coherence.covis_neighbors=5 \
  --override matching.local_memory.observation_coherence.covis_max_seed_landmarks=512 \
  --override matching.local_memory.observation_coherence.max_seed_frames=64 \
  --override matching.local_memory.observation_coherence.min_unique_anchors=20 \
  --override matching.local_memory.observation_coherence.min_unique_landmarks=20 \
  --override matching.local_memory.observation_coherence.score_weight=1.0 \
  --override matching.local_memory.observation_coherence.anchor_weight=0.10 \
  --override matching.local_memory.observation_coherence.landmark_weight=0.05 \
  --override matching.local_memory.observation_coherence.staticness_weight=0.03 \
  --override matching.local_memory.observation_coherence.restrict_to_preferred_frames=true \
  --override matching.local_memory.observation_coherence.unique_landmark_per_anchor=true \
  --override matching.local_memory.observation_coherence.fallback_to_unconstrained=true \
  --override matching.fine_rerank.enabled=false \
  --override matching.fine_primary=false \
  --override matching.materialize_topk_per_anchor=3 \
  ...
  --override pnp.reproj_error_px=6.0 \
  --override pnp.iterations=8000 \
  --override pnp.multi_pass=false
