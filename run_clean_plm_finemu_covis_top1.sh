...
OUT=outputs/loo_aachen_benchmark/loo_aachen_500/plm_clean_spmu_covis_top1
...
TORCH_HOME=/tmp/torch-hub /home/andreas/anaconda3/envs/sam3/bin/python \
  ...
  --override matching.fine_primary_topk=40 \
  --override matching.fine_primary_direct_score=true \
  --override matching.fine_primary_staticness_weight=0.03 \
