...
SRC=outputs/loo_aachen_benchmark/loo_aachen_500/plm_clean_xfeatobs_covis_mhyp_top3
OUT=outputs/loo_aachen_benchmark/loo_aachen_500/plm_clean_xfeatobs_covis_mhyp_top3_simplegraph
...
TORCH_HOME=/tmp/torch-hub /home/andreas/anaconda3/envs/sam3/bin/python \
  ...
  --override matching.graph_filter.min_matches=12 \
  --override matching.graph_filter.min_component_size=8 \
  --override matching.graph_filter.min_degree=1 \
  --override matching.graph_filter.min_keep=24 \
  --override matching.graph_filter.keep_largest_component=true \
